          ...
          {ITEMS.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5">
                <span className="inline-block rounded-full bg-background/90 px-2.5 py-1 text-xs font-medium text-foreground">
                  {item.tag}
                </span>
                <h3 className="mt-3 text-lg leading-snug font-semibold text-background">
                  {item.title}
                </h3>
              </div>
            </article>
