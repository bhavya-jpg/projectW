  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter 
          ? "z-10 bg-[#1c1917] dark:bg-[#27272a] text-white border-[#1c1917] dark:border-[#27272a]" 
...
export const StaggerTestimonials: React.FC<StaggerTestimonialsProps> = ({ items }) => {
  ...
  const [testimonialsList, setTestimonialsList] = useState<TestimonialItem[]>(() => items || defaultTestimonials);
